...
import 'package:user_app/global/globals.dart';
import 'package:user_app/info_handler/app_info.dart';
import 'package:user_app/main_screen/rate_driver_screen.dart';
import 'package:user_app/main_screen/search_places_screen.dart';
import 'package:user_app/main_screen/select_nearest_active_driver_screen.dart';
import 'package:user_app/models/active_driver_model.dart';
import 'package:user_app/widgets/custom_msg.dart';
import 'package:user_app/widgets/map_black_theme.dart';
import 'package:user_app/widgets/my_drawer.dart';
import 'package:user_app/widgets/pay_fare_amount_dialog_box.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  updateReachingTimeToUserDropOffLocation(driverCurrentPositionLatLng) async {
    if (requestPositionInfo == true) {
      ...
      LatLng userDropOffDestinationPosition = LatLng(dropOffLocation!.locationLatitude!, dropOffLocation.locationLongitude!);
  ...
  searchNearestOnlineDrivers() async {
    ...
    var response = await Navigator.push(
        context, MaterialPageRoute(builder: (c) => SelectNearestActiveDriversScreen(referenceRideRequest: referenceRideRequest!)));
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                            primary: Colors.green, textStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                      ),
                    ],
                  ),
                ),
