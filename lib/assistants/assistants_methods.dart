...
import 'package:user_app/models/history_model.dart';
...
class AssistantMethods {
  ...
  static Future<DirectionDetailInfo?> obtainOriginToDestinationDirectionDetails(LatLng origionPosition, LatLng destinationPosition) async {
  ...
  static void readTripKeysForOnlineUser(BuildContext context) {
    FirebaseDatabase.instance.ref().child("All Ride Requests").orderByChild("userName").equalTo(userModel!.name).once().then((snap) {
      if (snap.snapshot.value != null) {
